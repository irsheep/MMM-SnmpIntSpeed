...
function PrepareData() {
    ...
    if (fs.existsSync(dataFile)) {
        ...
        if (!savedJson.hasOwnProperty(host)) {
            // If the IP/name of the host changed then reinitialize
            savedJson[host] = []
    ...
    if (typeof savedJson[host] === 'undefined') { return { download: 0, upload: 0 } }
    ...
    if (typeof liveData.timestamp !== 'undefined' || typeof savedData.timestamp !== 'undefined') {
